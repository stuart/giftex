defmodule Giftex.FileTest do
  ...
  test "importing a file" do
    assert {:ok, [%{type: :description} | _]} = Giftex.parse_file ("#{__DIR__}/support/gift_test.txt")
  end

  test "importing a bad file" do
    q = Giftex.parse_file ("#{__DIR__}/support/gift_bad_test.txt")
  ...
  test "file error is passed on" do
    assert {:error, :enoent} = Giftex.parse_file ("foo.txt")
  end
end
